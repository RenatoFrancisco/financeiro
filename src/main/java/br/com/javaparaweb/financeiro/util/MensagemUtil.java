...
public class MensagemUtil {
	...
	private static final String PACOTE_MENSAGENS_IDIOMA = "br.com.javaparaweb.financeiro.idioma.mensagens";
	...
	public static String getMensagem(Locale locale, String propriedade) {
		ResourceBundle bundle = ResourceBundle.getBundle(PACOTE_MENSAGENS_IDIOMA, locale);
		return bundle.getString(propriedade);
	}
