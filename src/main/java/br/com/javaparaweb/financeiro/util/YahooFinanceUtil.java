...
public class YahooFinanceUtil {
	...
	private static final String SUFIXO_ACAO_BOVESPA = ".SA";
	...
	public static String getInfoCotacao(int indiceInformacao, Acao acao)
		...
		try {
			...
			throw new UtilException(
					"Não foi possível recuperar cotação. Erro: "
							+ e.getMessage());
		}
	}
}
